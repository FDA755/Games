...
{
	internal class PbLeft : GameObject
	{
		//public PbLeft(Context context) : base(context)
		//{
		//	Bitmap = BitmapFactory.DecodeResource(context.Resources, Resource.Drawable.pbLeft);
