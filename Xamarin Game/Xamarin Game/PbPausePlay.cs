...
{
	internal class PbPausePlay : GameObject
	{
		//public PbPausePlay(Context context) : base(context)
		//{
		//	Bitmap = BitmapFactory.DecodeResource(context.Resources, Resource.Drawable.pbPausePlay);
